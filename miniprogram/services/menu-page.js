const { attachCloudMenu } = require('./menu-cloud-page')
...
function createMenuPage(options = {}) {
const menuData = options.initialMenu || { shop: { name: '宝宝菜单' }, categories: [] }
...
return attachCloudMenu(definition, options, { normalizeCategories, getPageStyle }, options.wxApi || (typeof wx === 'undefined' ? null : wx))
}

module.exports = { createMenuPage }
